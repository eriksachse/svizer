<script>
  import Svizer from "../lib/Svizer.svelte";
</script>
...
<div>
  ...
  sea takimata sanctus est Lorem ipsum dolor sit amet. Duis autem vel eum iriure
  ...
  illum dolore eu feugiat nulla facilisis. At vero eos et accusam et justo duo
  ...
  sed tempor et et invidunt justo labore Stet clita ea et gubergren, kasd magna
  no rebum. sanctus sea sed takimata ut vero voluptua. est Lorem ipsum dolor sit
  ...
  rebum. Stet clita kasd gubergren, no sea takimata sanctus. Lorem ipsum dolor
...
<Svizer
  ...
  handlecolor={"brown"}
  showcorner={true}
  handlewidth={3}>Test text</Svizer
>
